...
var	height1=$(window).innerHeight();
		...
		jQuery(".home_promo,.home_promo .adorno-slider .bx-wrapper").width(factor*1920);
		jQuery(".home_promo,.home_promo .adorno-slider .bx-wrapper").height(factor*1082);
		...
		var margin=((factor*400)-(jQuery(".home-title").height()+jQuery(".home-desc").height()+parseInt(jQuery(".home-desc").css("margin-top"))+jQuery(".home-more-btn").height()+parseInt(jQuery(".home-more-btn").css("margin-top"))))/2;
...
?>
<div class="row home_promo nopadding" >
...
<div class="fading-slider adorno-slider" >
                ...
                <li ><img src="images/top.jpg" class="img-responsive"/></li>
                
                
             <li ><img src="images/top1.jpg" class="img-responsive"/></li>
             <li ><img src="images/top2.jpg" class="img-responsive"/></li>
             <li ><img src="images/top3.jpg" class="img-responsive"/></li>
...
<?php if($this->params->get('subCategories') && isset($this->subCategories) && count($this->subCategories)): ?>
		...
		$ss=mb_substr($ss,0,300, "utf-8").'...';
			   ...
			   ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 home-desc visible-lg visible-md revealOnScroll" data-animation="fadeInRight" data-timeout="300"><?php echo $ss; ?></div>
               ...
               <div class="row nopadding">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 home-desc visible-lg visible-md revealOnScroll" data-animation="fadeInLeft" data-timeout="300"><?php echo $ss; ?></div>
...
//jQuery("#slider-text-0 p").toggleClass("animated fadeIn");

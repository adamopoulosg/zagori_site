...
<div class="row main_top_promo" style="background-image:url(<?php echo $this->category->image; ?>); background-repeat:no-repeat; background-size:cover;">
 ...
 <div class="main_top_text_title bluetxt"><h1><?php echo $this->category->name; ?></h1></div>
 <div class="main_top_text_body blacktxt"><?php echo $this->category->description; ?></div>
 </div>
</div>
...
<div class="row nopadding main-thumbs news-list">
			...
			<?php foreach($this->leading as $key=>$item): ?>
				...
				<?php
					...
					echo $this->loadTemplate('item');
						...
						echo '<div class="clearfix"><p><br></p></div>';
